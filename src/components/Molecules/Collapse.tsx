...
export const Collapse = ( {label, children}: CollapseProps) => {
  ...
  return (
    <div className='shadow-md rounded-b'>
      <div onClick={() => toggleCollapse(!collapseState)} className='flex cursor-pointer justify-between rounded relative z-10 shadow px-4 py-3 bg-amber-500'>
      ...
      <div ref={collapse} style={ {height: collapseState ? collapseHeight + 'px'  : '0px'} } className={`h-full ease-out duration-200 transition-[height] overflow-hidden`}>
